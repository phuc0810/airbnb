...
function UserTemplate(props: Props) {
  return (
    <Route
      ...
      path={props.path}
      render={() => {
        let componentUserTemplate = undefined;
        let title = "";
        if (props.path === "/dangnhap") {
          componentUserTemplate = <Login />;
          title = "Đăng Nhập";
        } else if (props.path === "/dangky") {
          componentUserTemplate = <Register />;
          title = "Đăng Ký";
        }
        return (
          <Fragment>
